...
int main() {
	...
	Player* player1 = new Player("foo", new HumanPlayer);
	...
	// Using PlayerStrategy only for demo, should call from inside Player, player->attack();
	cout << "\nStarting with cheater player" << endl;
	PlayerStrategy playerStrategy(new CheaterPlayer); // Create PlayerStrategy with Cheater
	cout << "Reinforcing with cheater player" << endl;
	playerStrategy.playerReinforcement(player1, TestHand, 0);
	cout << "Attacking with cheater player" << endl;
	playerStrategy.playerAttack(player1);
	cout << "Fortifying with cheater player" << endl;
	playerStrategy.playerFortify(player1);
	cout << "\nChanging to random player" << endl;
	playerStrategy.setStrategy(new RandomPlayer); // change startegy to Random Player.
	cout << "Reinforcing with random player" << endl;
	playerStrategy.playerReinforcement(player1, TestHand, 0);
	cout << "Attacking with random player" << endl;
	playerStrategy.playerAttack(player1);
	cout << "Fortifying with random player" << endl;
	playerStrategy.playerFortify(player1);
